            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="#" class="m-bot-20 footer-logo">
                        <img class="retina" src="{{asset('massive/assets/img/logo-dark.png')}}" alt="" />
                    </a>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="r-work">
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/1.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/2.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/3.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/4.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/5.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/6.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/7.jpg')}}" alt="" />
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{asset('massive/assets/img/recent-work/8.jpg')}}" alt="" />
                            </a>
                        </li>
                    </ul>
                </div>
